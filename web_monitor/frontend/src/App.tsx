    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 p-4">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          {!remoteSystem.loading && remoteSystem.info && (
            <SystemInfoCard 
           ...
           {remoteSystem.error && !remoteSystem.loading && (
            <SystemInfoCard 
              title="Remote Host System Status" 
              systemInfo={null} 
              error={remoteSystem.error} 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {!remoteNetwork.loading && remoteNetwork.devices && (
            <NetworkStatusCard 
           ...
           {remoteNetwork.error && !remoteNetwork.loading && (
            <NetworkStatusCard 
              title="Remote Host Network Devices" 
              networkStatus={[]} 
              error={remoteNetwork.error} 
